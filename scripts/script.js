/*Datos generales para funcinamiento de líneas, columnas y gráficos*/
...
/*Cuadros de referencia a colores para que se relaciones con los gráficos de los dulces*/
const COLORS = ['red', 'green', 'blue', 'yellow'];

const FALL_SPEED = 300;

$(function(){
    //Código general del juego
